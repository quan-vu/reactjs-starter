...
const MenuLocation = () => {
  ...
  return (
    <div className={css.menuBtnWrap}>
      <Button
        className={clsx(css.menuBtn, anchorEl && css.menuBtnActive)}
        onClick={handleClick}
        endIcon={<ExpandMoreIcon className={css.menuBtnIcon} />}
      >
      ...
      >
        <div className={css.menuItem}>
          <StyledAutocomplete
            className={clsx(css.menuItemAuto)}
            options={top100Films}
        ...
        <div className={css.menuItemSubmit}>
